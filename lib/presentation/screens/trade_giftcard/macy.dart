...
class MacyGiftCardScreen extends StatefulWidget {
  const MacyGiftCardScreen({super.key});

  @override
  State<MacyGiftCardScreen> createState() => _MacyGiftCardScreenState();
}

class _MacyGiftCardScreenState extends State<MacyGiftCardScreen> {
