...
class WalmartGiftCardScreen extends StatefulWidget {
  const WalmartGiftCardScreen({super.key});

  @override
  State<WalmartGiftCardScreen> createState() => _WalmartGiftCardScreenState();
}

class _WalmartGiftCardScreenState extends State<WalmartGiftCardScreen> {
