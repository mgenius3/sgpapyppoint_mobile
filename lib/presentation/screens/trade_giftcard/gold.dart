...
class RazerGoldGiftCardScreen extends StatefulWidget {
  const RazerGoldGiftCardScreen({super.key});

  @override
  State<RazerGoldGiftCardScreen> createState() =>
      _RazerGoldGiftCardScreenState();
}

class _RazerGoldGiftCardScreenState extends State<RazerGoldGiftCardScreen> {
