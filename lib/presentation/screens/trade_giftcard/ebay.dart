...
class EbayGiftCardScreen extends StatefulWidget {
  const EbayGiftCardScreen({super.key});

  @override
  State<EbayGiftCardScreen> createState() => _EbayGiftCardScreenState();
}

class _EbayGiftCardScreenState extends State<EbayGiftCardScreen> {
