...
class AmazonGiftCardScreen extends StatefulWidget {
  const AmazonGiftCardScreen({super.key});

  @override
  State<AmazonGiftCardScreen> createState() => _AmazonGiftCardScreenState();
}

class _AmazonGiftCardScreenState extends State<AmazonGiftCardScreen> {
