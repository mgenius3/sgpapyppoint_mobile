...
class NordstormGiftCardScreen extends StatefulWidget {
  const NordstormGiftCardScreen({super.key});

  @override
  State<NordstormGiftCardScreen> createState() =>
      _NordstormGiftCardScreenState();
}

class _NordstormGiftCardScreenState extends State<NordstormGiftCardScreen> {
